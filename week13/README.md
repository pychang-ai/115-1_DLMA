# 第 13 週｜TensorBoard 進階與經典架構（2026/12/04）

- 對應教科書：CH07 TensorBoard 進階技巧＋CH08 卷積神經網路經典架構
- 教學內容：
  - 7-1 tf.summary（scalar／image／text／audio／histogram）
  - 7-3 實驗二：HParams 超參數調校工具
  - 8-1 神經網路架構演進、8-2 實驗：EfficientNetB0／InceptionV3

## 隨堂作業

作業W13：用 HParams 跑 12 組超參數（每組 3 epochs），截圖面板並指出最佳組合
